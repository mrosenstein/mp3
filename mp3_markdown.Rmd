...
ggplot(temp_data, aes(x = when)) +
  ...
  geom_bar(aes(y = sap), stat = "identity", position = position_dodge(), color = "brown")
...
ggplot(mass_data, aes(x = year, y = season_length)) +
  geom_bar(aes(y = yield_per_tap), stat = "identity", position = position_dodge()) +
  geom_bar(aes(y = season_length), stat = "identity", position = position_dodge())
