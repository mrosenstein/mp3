...
The following table joined the whateley weather data with the sap collection data and analyzed the temperature highs and lows relative to sap collection. The red line indicates the temperature high of the date and the blue line represents the temperature low.
```{r warning = FALSE}
